...
const GritMomentManagement: React.FC = () => {
  ...
  const copyLink = (urlId: string) => {
    const link = `https://teamgrit.asyncsite.com/grit-moments/pay?id=${urlId}`;
          ...
          <tbody>
            {prices.map((price) => (
              <tr key={price.id}>
                ...
                <Td>
                  <UrlContainer>
                    <UrlText>teamgrit.asyncsite.com/grit-moments/pay?id={price.urlId}</UrlText>
          ...
          <Modal onClick={(e) => e.stopPropagation()}>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <FormGroup>
                ...
                />
                <HelpText>결제 링크: teamgrit.asyncsite.com/grit-moments/pay?id={formData.urlId || 'id'}</HelpText>
              </FormGroup>
              <FormGroup>
                <Label>결제 금액 *</Label>
                <AmountSelect
